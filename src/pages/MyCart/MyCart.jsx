  ...
  return (
    <div className="bg-[#F4F3F0] py-16 mb-[100px]">
      <div className="max-w-[1320px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mx-auto gap-10 px-5 md:px-5 lg:px-0 my-16">
          {myCart.map((cart) => (
            <div key={cart._id}>
              <div className="card bg-base-100 shadow-xl ">
                ...
                <div className="card-body text-center bg-orange-200">
                  ...
                  <p className="font-semibold text-lg">Price: {cart.price}$ </p>
                  <div className="">
